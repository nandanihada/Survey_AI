...
@cross_origin(supports_credentials=True, origins="*")
def check_email_triggers(survey_id):
...
def test_email():
    ...
    try:
        ...
        test_result = email_trigger_service.send_email(
            to_email=to_email,
            subject="Test Email from Survey System",
...
try:
    ...
    LINK_MASKING_AVAILABLE = True

    print("✅ Link masking system imported successfully")


except ImportError as e:

    print(f"⚠️ Link masking system not available: {e}")
...
def manage_suggestion_filters():
    ...
    if request.method == "GET":
        ...
        try:
            ...
            filters_cursor = db.suggestion_filters.find().sort("priority", 1)

            filters = []

            for filter_doc in filters_cursor:
        ...
        try:
            ...
            result = db.suggestion_filters.insert_one(filter_doc)
...
def manage_suggestion_filter(filter_id):
    ...
    try:
        ...
        if request.method == "GET":
            ...
            filter_doc = db.suggestion_filters.find_one({"_id": filter_id})
            ...
            return jsonify({"filter": filter_doc})
            ...
            existing_filter = db.suggestion_filters.find_one({"_id": filter_id})
            ...
            result = db.suggestion_filters.delete_one({"_id": filter_id})
...
def initialize_default_suggestion_filters():
    ...
    try:
        ...
        existing_count = db.suggestion_filters.count_documents({})
        ...
        for filter_data in default_filters:
            ...
            db.suggestion_filters.insert_one(filter_doc)

            inserted_filters.append(filter_id)
