...
def show_your_postback_urls():
    ...
    print("https://pepper-flask-app.onrender.com/postback-handler")
    print()
...
def explain_the_difference():
    ...
    print("   → Just give them: https://pepper-flask-app.onrender.com/postback-handler")
...
def main():
    ...
    print("\n✅ SUMMARY:")
    print("1. Give AdBreak this URL: https://pepper-flask-app.onrender.com/postback-handler")
