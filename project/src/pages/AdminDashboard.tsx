...
import LoadingAnimationTab from '../components/admin/LoadingAnimationTab';
import {
  ...
  ChevronRight, Shield, RefreshCw, Layers, GitBranch, MousePointerClick, Send, Search, Linkedin, Calendar, Zap
} from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  ...
  const NAV_GROUPS: NavGroup[] = [
    ...
    { label: 'Engagement', items: [
      ...
      { id: 'loading-animation',      icon: <Zap size={14} />,             label: 'Loading Animation' },
    ]},
    { label: 'System',     items: [
          ...
          <main style={{ flex: '1 1 0', overflowY: 'auto', overflowX: 'hidden', padding: 22, height: '100%' }}>
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <p style={{ fontSize: 11, color: '#9B9189', marginTop: 3 }}>
                ...
                {activeTab === 'loading-animation' && 'Survey creation loading animation — choose which animation users see during generation'}
              </p>
            </div>
            ...
            <div style={{ background: '#FDFCFA', borderRadius: 14, border: '1px solid #EBE8E3', boxShadow: '0 1px 6px rgba(45,37,32,0.05)', overflow: 'hidden' }}>
              {loading ? (
                ...
                {/* Loading Animation Tab */}
                {activeTab === 'loading-animation' && (
                  <LoadingAnimationTab />
                )}
