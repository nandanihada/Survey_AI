...
const PostbackReceiver: React.FC<{ isDarkMode: boolean }> = ({ isDarkMode }) => {
    ...
    const baseUrl = window.location.hostname.includes('localhost') || window.location.hostname === '127.0.0.1'
        ...
        : 'https://surevy-pepperwahl.onrender.com/postback-handler/{YOUR_UNIQUE_ID}';
  
    const fullUrl = `${baseUrl}`;
    const productionUrl = 'https://surevy-pepperwahl.onrender.com/postback-handler/{YOUR_UNIQUE_ID}';
...
const PostbackSharingManager: React.FC<{ isDarkMode: boolean }> = ({ isDarkMode }) => {
    ...
    const generatePreviewUrl = () => {
        ...
        const baseUrl = `https://surevy-pepperwahl.onrender.com/postback-handler/${uniqueId}`;
        const params: string[] = [];
